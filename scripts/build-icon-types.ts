...
// custom icon names that must be resolved manually inside of the Icon component
const CUSTOM_ICON_NAMES = ["spinner"];
 ...
 */
export type IconName = ${[...CUSTOM_ICON_NAMES, ...Object.keys(remixicon)]
    .map((icon) => `"${icon}"`)
    .join("|")};`;
